 ...
 */
export function getArticleList(pageNum: number): Promise<ArticleList> {
  return HttpManager.get(`/article/list/${pageNum}/json`);
}
 ...
 * - 页码：拼接在链接上，从0开始。
 */
export function getArticleListByCid(pageNum: number, cid: string): Promise<ArticleList> {
